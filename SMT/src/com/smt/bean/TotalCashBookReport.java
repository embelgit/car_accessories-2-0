...
public class TotalCashBookReport {
	...
	public TotalCashBookReport(String name, String custType,
			String paymentType, String paymentBy, double chequeNo,
			String chequeDate, double cardNo, double neftAccNo, double amount,
			String reason) {
		super();
		this.name = name;
