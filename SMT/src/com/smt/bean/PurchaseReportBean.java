...
public class PurchaseReportBean {
	...
	private Double fivePercentageSGST;
	private Double twelwePercentageSGST;
	private Double eighteenPercentageSGST;
	...
	public void setFivePercentageSGST(Double fivePercentageSGST) {
		this.fivePercentageSGST = fivePercentageSGST;
	}
	public Double getTwelwePercentageSGST() {
		return twelwePercentageSGST;
	}
	public void setTwelwePercentageSGST(Double twelwePercentageSGST) {
		this.twelwePercentageSGST = twelwePercentageSGST;
	}
	public Double getEighteenPercentageSGST() {
		return eighteenPercentageSGST;
	}
	public void setEighteenPercentageSGST(Double eighteenPercentageSGST) {
		this.eighteenPercentageSGST = eighteenPercentageSGST;
	}
	public Double getTwentyEightPercentageSGST() {
		return twentyEightPercentageSGST;
	}
	public void setTwentyEightPercentageSGST(Double twentyEightPercentageSGST) {
		this.twentyEightPercentageSGST = twentyEightPercentageSGST;
	}
