...
<form action="supplierwiseBill" method="post" class="form-horizontal">
	<div class="col-lg-12">
		<div class="form-group-2">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 ">
				<input type="text" id="total" name="total" class="form-control" placeholder="Total Pay" style="background-color: black;">
			</div>
		</div>
	</div>
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-2"><strong>Credit Amount</strong></div>
			<div class="rTableHead col-md-2"><strong>Debit Amount</strong></div>
			<div class="rTableHead col-md-2"><strong>VAT</strong></div>
