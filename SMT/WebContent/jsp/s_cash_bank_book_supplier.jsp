	...
	<div class="container-fluid">
		...
		<form action="cashBankBook" name="cashboook" method="post"
			...
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="col-sm-2" align="center">
						<label class="control-label" style="font-family: Times New Roman;">Bill No:</label>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
			...
			<div class="row">
				<div class="form-group" align="center">
					<div class="col-sm-2 col-sm-offset-1">
						<label class="control-label" style="font-family: Times New Roman;">Total Amount:</label>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
			...
			<div class="row">
				<div class="form-group" align="center">
					<div class="col-sm-2 col-sm-offset-1">
						<label class="control-label" style="font-family: Times New Roman;">Payment Type:</label>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
					...
					<div class="col-sm-2" align="center">
						<label class="control-label" style="font-family: Times New Roman;">Registration No:</label>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
			...
			<div class="row buttons_margin_top">
				<div align="center">
					<input type="button"
						...
						name="btn" value="Save" onclick="cash()"/> 
					 <input type="button"
