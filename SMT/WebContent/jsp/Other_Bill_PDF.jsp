...
<%
	...
	try {
       ...
       // PrintStream ps = new PrintStream(baos);
		...
		ResultSet rs = stmt.executeQuery("select ItemName, CategoryName, Quantity, SalePrice, ContactNo, OwnerName, TotalAmount, Discount, GrossTotal, Date, totalperitem, TaxAmount,Gst from otherbill where BillNo =" + billno);
