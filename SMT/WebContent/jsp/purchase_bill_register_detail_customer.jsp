...
<%@include file="commons/header.jsp"%>
    ...
    <link href="/SMT/jsp/purchase_bill_register_detail(customer).jsp" rel="stylesheet"/>
...
<form action="purchaseBillRegisterDetail(Customer)" method="post" class="form-horizontal">
	<div class="col-lg-12">
