...
<form action="tax" method="post" class="form-horizontal">
	<div class = "col-lg-12 form-group-1">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
			<input type="text" name="taxType" id="taxType" class="form-control" placeholder="Tax Name">
		</div>
	...
	<div class="wrapper">
		<input type="button" onclick="taxCreation()" value="Save" class="btn btn-lg btn-success btn-md">
	</div>
