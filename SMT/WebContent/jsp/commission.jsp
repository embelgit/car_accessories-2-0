...
<form action="commission" method="post" class="form-horizontal">
	...
	<div class = "col-lg-12 form-group-1">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6" style="margin-left: -50px;">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
			<input class="form-control" type="text" name="targetGiven" placeholder="Target Given" />
		</div>
	</div>
	...
	<div class = "col-lg-12 form-group-1">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
			<input class="form-control" type="text" name="targetAchieved" placeholder="Target Achieved" />
		</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6" style="margin-left: -50px;">
			<input class="form-control" type="text" name="productwiseTarget" placeholder="Productwise Target" />
		</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
			<input class="form-control" type="text" name="periodOfTarget" placeholder="Period Of Target" />
		</div>
	</div>
	...
	<div class = "col-lg-12 form-group-1">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
			<input class="form-control" type="text" name="totalPoints" placeholder="Total Points" />
		</div>
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6" style="margin-left: -50px;">
			<input class="form-control" type="text" name="incentiveAmount" placeholder="Incentive Amount" />
		</div>
	</div>
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-1"><strong>Target Given</strong></div>
			<div class="rTableHead col-md-2"><strong>Target Achieved</strong></div>
			<div class="rTableHead col-md-2"><strong>Productwise Target</strong></div>
			<div class="rTableHead col-md-1"><strong>Period Of Target</strong></div>
			<div class="rTableHead col-md-1"><strong>Total Points</strong></div>
			<div class="rTableHead col-md-2"><strong>Incentive Amount</strong></div>
		</div>
