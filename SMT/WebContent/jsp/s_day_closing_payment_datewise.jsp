...
<%@include file="y_commons/header1.jsp"%>
 ...
 <body class="report_form_img">
	<div class="container-fluid">
			...
			<div align="center">
				<h2 class="form-name style_heading">Day Closing Payment Between Two Dates</h2>
			</div>
		</div>
		...
		<div class="row buttons_margin_top">
				<div align="center">
					<input  type="button" value="Search"  onclick="sale.getDayClosingBetweenTwoDates()" class="btn btn-lg btn-success btn-md button_margin_right"/>
				</div>
			</div>
