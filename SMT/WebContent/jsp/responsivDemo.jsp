                    ...
                    <div class="panel-body">
                        <form action="Login" method="post">
                            <div>
                                ...
                                <input type="button" value="Login" onclick="login()" class="btn btn-md btn-lg btn-success"   />
                                <input type="reset" value="Reset" class="btn btn-md btn-lg btn-danger" /><br>
                                Yet Not Registered!! <a href="/SMT/jsp/reg.jsp">Register Here</a>
                            </div>
                        </form>
                    </div>
                </div>
