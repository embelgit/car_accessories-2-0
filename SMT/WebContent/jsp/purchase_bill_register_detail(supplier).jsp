...
<%@include file="commons/header.jsp"%>
	...
	<div class="container">
		<h2 class="form-name">Purchase Bill Register Details(Supplier)</h2>
	</div>
	
	<script src="/SMT/staticContent/js/jquery-1.12.3.min.js"></script>
    <script src="/SMT/staticContent/css/adi.css"></script>
    <link href="/SMT/jsp/purchase_bill_register_detail(supplier).jsp" rel="stylesheet"/>
...
<form action="purchaseBillRegisterDetail(Supplier)" method="post" class="form-horizontal">
	<div class="col-lg-12">
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-1"><strong>Model No</strong></div>
