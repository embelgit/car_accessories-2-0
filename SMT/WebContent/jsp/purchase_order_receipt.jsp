...
<form action="purchaseOrderReceipt" method="post" class="form-horizontal">
	<div class="form-group-2">
		<div class="col-lg-12">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
				<input class="form-control" type="text" name="poNo" placeholder="PO No"/>
			</div>
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-2"><strong>Color</strong></div>
		...
		<div class="rTableRow">
			...
			<div class="rTableLabel col-md-2"><strong>Total Amount</strong></div>
			<div class="rTableCell col-md-2"><input type="text" class="form-control"/></div>
		</div>
		
		<div class="rTableRow">
			<div class="col-md-8 col-lg-8 col-sm-8 col-xs-12"></div>
			<div class="rTableLabel col-md-2"><strong>Discount</strong></div>
			<div class="rTableCell col-md-2"><input type="text" class="form-control"/></div>
		</div>
