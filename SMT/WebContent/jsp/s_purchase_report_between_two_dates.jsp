...
<%@include file="y_commons/header1.jsp"%>
    ...
    <script src="/SMT/staticContent/y_js/goodsreceived.js"></script>
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading"> Purchase Report Between Two Dates</h2>
			</div>
		</div>
			...
			<div class="row">
				...
				<div align="center">
					<input type="button"
						...
						name="btn" value="Search" onclick="purchasedays.getPurchaseDetailsBetweenTwoDay()" />
				</div>
			</div>
