...
<form action="diss" method="post" class="form-horizontal">
	<div class="col-lg-12">
		<div class="col-lg-12 form-group-1" style="padding-bottom: 0px;">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 first">
				<input type="text" class="form-control" name="Search" placeholder="Search" style="padding-left: 123px;" />
			</div>
		...
		<div class="col-lg-6 form-group-1">
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-6" style="margin-left: 227px;">
			...
			<div>
			 ...
			 <div class="col-lg-1 col-md-1 col-sm-1 col-xs-6" style="margin-left: 30px;">
				<input type="radio" name="search item" value="Category"
					onclick="hide();" /> Category
			</div>
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-6" style="margin-left: 41px;">
			...
			<div class="col-lg-1 col-md-1 col-sm-1 col-xs-6" style="margin-left: 7px;">
	...
	<div class="col-lg-12">
		<div class="form-group-1">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
				<input class="form-control" type="text" name=" priceQuantity" placeholder="Price/Quantity" />
			</div>
	...
	<div class="col-lg-12">
		<div class="form-group-1">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
				<input class="form-control" type="text" name=" discountedPrice/Quantity" placeholder="Discounted Price/Quantity" />
			</div>
	...
	<div class="rTable">
		<div class="rTableRow">
			<div class="rTableHead col-md-1"><strong>Item Id</strong></div>
			<div class="rTableHead col-md-2"><strong>Item Name</strong></div>
			<div class="rTableHead col-md-2"><strong>Purchase Qty/Price</strong></div>
			<div class="rTableHead col-md-1"><strong>Discount Qty/Price</strong></div>
			<div class="rTableHead col-md-2"><strong>New Rate</strong></div>
			<div class="rTableHead col-md-1"><strong>Start Date</strong></div>
			<div class="rTableHead col-md-1"><strong>End Date</strong></div>
			<div class="rTableHead col-md-2"><strong>Delete/Edit Symbol(Action)</strong></div>
		</div>
	...
	<div class="wrapper">
		<input type="button" value="Submit" class="btn btn-lg btn-success btn-md" onclick="discountModule()" /> 
