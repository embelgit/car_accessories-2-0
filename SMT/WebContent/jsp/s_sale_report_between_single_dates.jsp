...
<%@include file="y_commons/header1.jsp"%>
    ...
    <script type="text/javascript" src="/SMT/staticContent/y_js/jqueryUi.js"></script>
        ...
        <link href="/SMT/staticContent/css/y_select.css"  rel="stylesheet" type="text/css" media="all">
        <link href="/SMT/staticContent/css/y_button.css"  rel="stylesheet" type="text/css" media="all">
			...
			<div class="row">
				...
				<div class="form-group">
					<div class="col-sm-2 col-sm-offset-1" align="center">
						<label class="control-label" style="font-family: Times New Roman;">Enter Date:</label>
					</div>
					<div class="col-sm-3">
				...
				<div align="center">
						...
						<input type="button" value="Search"  id="btn" onclick="  saleforDate.saleHelperForsingleDate() ; "class="btn btn-lg btn-success btn-md button_margin_right"/>
				</div>
			</div>
