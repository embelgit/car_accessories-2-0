...
<div class="col-lg-12">
		...
		<div class="form-group-2">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
					<input type="button" value="Search"  id="btn" onclick="  payment.paymentHelperForsingleDate() ; " class="btn btn-lg btn-Success ">
					</div>
			</div>
		...
		<div style='position:absolute; top:252px;     left: 600px;'>
			 ...
			 <input type="button" value="get Total"  id="btn" onclick=" getTotal()" class="btn btn-lg btn-Success">
		...
		<div class="form-group-2">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
				<input type="text" id="saleitem" class="form-control" style="font-size: 30px; width: 180px;
height: 60px; " > 
				</div>
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
				<input type="text" id="resolution2" class="form-control" style="font-size: 30px; width: 180px;
height: 60px;">  
				</div>
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
				<input type="text" id="resolution" class="form-control" style="font-size: 30px ;width: 180px;
height: 60px; "> 
				</div>
