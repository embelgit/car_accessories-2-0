...
<%@include file="y_commons/header1.jsp"%>
 ...
 <div class="container" style="float: left"> 
 	 ...
 	 <ul class="nav nav-tabs">
	    ...
	    <li><a data-toggle="tab" href="#CatWise"><h4 style="color:blue">Category Wise</h4></a></li>
	    <li><a data-toggle="tab" href="#gstWise"><h4 style="color:blue">GST Wise</h4></a></li>
	    <li><a data-toggle="tab" href="#BarcodeWise"><h4 style="color:blue">Barcode Wise</h4></a></li>
 	 </ul>
    	...
    	<div class="row"></div>
 			<form class="form-horizontal" method="post" action="" name="">
				<fieldset>
					...
					<table class= "table table-bordered table-striped table-condensed cf" style=" border: 2px solid black;border-collapse: collapse;" id="example" class="display	" style="width: 1300px;">
						<thead>
							<tr>
								<th>Bill No</th>
								<th>Car No</th>
					...
					<fieldset>
				       ...
				       <div class="row form-group buttons_margin_top ">
												<div align="center">
												    ...
												    <input type="button"  id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right"onclick="getSaleDetailsBetweenTwoDates()" value="Search"/>
												     									
												</div>
									</div>	
						<table class= "table table-bordered table-striped table-condensed cf" style=" border: 2px solid black;border-collapse: collapse;" id="example1" class="display" style="width: 1300px;">
						<thead>
							<tr>
								<th>Bill No</th>
								<th>Car No</th>
 			...
 			<div class="row"></div>
 				<form class="form-horizontal" method="post" action="" name="fertiBill">
					<fieldset>
				       ...
				       <div class="row form-group buttons_margin_top ">
								<div align="center">
										<input type="button"  id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="CategoryWiseSale()" value="Search"/>
								</div>
									</div>	
						<table class= "table table-bordered table-striped table-condensed cf" style=" border: 2px solid black;border-collapse: collapse;" id="example3" class="display" style="width: 1300px;">
						<thead>
							<tr>
								<th>Bill No</th>
								<th>Car No</th>
 			...
 			<div class="row"></div>
 				<form class="form-horizontal" method="post" action="" name="fertiBill">
					<fieldset>
				       <div class="row" style="margin-top: 25px;">
						...
						<div class="col-sm-2">
						 			<div class="input-group">
										...
										<input list="barcodeId_drop" id="barcodeId" class="form-control">
				       ...
				       <div class="row form-group buttons_margin_top ">
								<div align="center">
										<input type="button"  id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="BarcodeWiseReport()" value="Search"/>
								</div>
									</div>	
						<table class= "table table-bordered table-striped table-condensed cf" style=" border: 2px solid black;border-collapse: collapse;" id="example5" class="display" style="width: 1300px;">
						<thead>
							<tr>
								<th>Date</th>
								<th>Item Name</th>
