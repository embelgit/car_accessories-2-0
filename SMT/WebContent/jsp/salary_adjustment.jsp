...
<form action="salaryAdjustment" method="post" class="form-horizontal">
	...
	<div class = "col-lg-12 form-group-1">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
			<input class="form-control" type="text" name="salaryAmount" placeholder="Salary Amount" />
		</div>
	</div>
	...
	<div class = "col-lg-12 form-group-1">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6" style="margin-left: -50px">
			<input class="form-control" type="text" name="amountGiven" placeholder="Amount Remaining" />
		</div>
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-2"><strong>Salary Amount</strong></div>
			<div class="rTableHead col-md-2"><strong>Advance Salary </strong></div>
			<div class="rTableHead col-md-2"><strong>Amount Remaining</strong></div>
