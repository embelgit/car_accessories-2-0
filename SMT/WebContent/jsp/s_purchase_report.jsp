...
<br>  <br>
		<div class="rTableRow">
			<div class="rTableHead col-md-1"><strong>Excepted Date</strong></div>
			<div class="rTableHead col-md-1"><strong>Order No</strong></div>
			<div class="rTableHead col-md-2"><strong>Order Date</strong></div>
			<div class="rTableHead col-md-2"><strong>Supplier Name</strong></div>
			<div class="rTableHead col-md-1"><strong>Item Name</strong></div>
			<div class="rTableHead col-md-2"><strong>Contact Person Name</strong></div>
			<div class="rTableHead col-md-1"><strong>Quantity</strong></div>
			<div class="rTableHead col-md-1"><strong>Rate</strong></div>
			<div class="rTableHead col-md-1"><strong>Net Amount</strong></div>
		</div>
		<br>  <br>
		<br>  <br>
		...
		<div class="rTableRow">
			...
			<div class="rTableLabel col-md-1"><br> <br> <strong>Total</strong></div> <br> <br>
			<div class="rTableCell col-md-1">
			<br> <br> <input type="text" class="form-control"/> <br> <br></div>
		</div>
	</div>
