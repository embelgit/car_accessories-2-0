...
<form action="loyaltyProgram" method="post" class="form-horizontal">
	...
	<div class="col-lg-12">
		<div class="form-group-1">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
				<input class="form-control" type="text" name="cardPoints" id="cardPoints" placeholder="Card Points " />
			</div>
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
				<input class="form-control" type="text" name="voucher" id="voucher" placeholder="Voucher" />
			</div>
		</div>
	</div>
	...
	<div class="wrapper">
		<input type="button" value="Save" onclick="lolp()" class="btn btn-lg btn-success btn-md" />  
