...
<%@include file="y_commons/header1.jsp"%>
	 ...
	 <div class="container-fluid">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading">CategoryWise Stock</h2>
			</div>
		</div>
		...
		<div class="row buttons_margin_top">
				<div align="center">
				<input type="button" value="Search" id="btn" onclick="getCategoryWiseStock();" class="btn btn-lg btn-success btn-md button_hw button_margin_right"/>
...
<div class="row" align="center">
  <div class="table-responsive">
	<table id="example" class= "table table-bordered table-striped table-condensed cf" class="display" style=" border: 2px solid black;border-collapse: collapse;">
		<thead>
			<tr>
