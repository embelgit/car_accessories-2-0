...
<form action="stockOutwardRegister" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			<div class="rTableHead col-md-1"><strong>Sr No</strong></div>
			<div class="rTableHead col-md-1"><strong>Date Of Dispatch</strong></div>
			<div class="rTableHead col-md-1"><strong>Outward to Branch</strong></div>
			<div class="rTableHead col-md-1"><strong>Voucher No</strong></div>
			<div class="rTableHead col-md-1"><strong>Goods Description</strong></div>
			<div class="rTableHead col-md-1"><strong>No Of Parcels</strong></div>
			<div class="rTableHead col-md-1"><strong>Quantity</strong></div>
			<div class="rTableHead col-md-2"><strong>Vehicle No</strong></div>
			<div class="rTableHead col-md-2"><strong>Delivery Person</strong></div>
