...
<form action="purchaseOrderRegister" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			<div class="rTableHead col-md-1"><strong>Sr No</strong></div>
			<div class="rTableHead col-md-2"><strong>PO No</strong></div>
			<div class="rTableHead col-md-2"><strong>PO Date</strong></div>
			<div class="rTableHead col-md-2"><strong>Expected Date</strong></div>
	...
	<div class="wrapper">
		...
		<a href="http://localhost:8080/SMT/jsp/purchase_order_receipt.jsp"> <h3>Receipt</h3></a>
	</div>
