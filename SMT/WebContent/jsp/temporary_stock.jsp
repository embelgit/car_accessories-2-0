...
<form action="temporaryStock" method="post" class="form-horizontal" name="tempstock">	
	...
	<div class="col-lg-12 form-group-1">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
			<input class="form-control" type="text" name="key" id="key" placeholder="Barcode No" onchange="offer.getitemData()"/>
		</div>
	...
	<div class="wrapper" style="position: absolute; top: 510px; left: 300px;">
	...
	<div class="col-lg-12 form-group-1">
    	...
    	<div class="col-lg-1 col-md-1 col-sm-1 col-xs-3">
    		<input  type="text" class="form-control"  name="resolution" id="resolution"  placeholder="GrossTotal" style="position: absolute;top: 310px;left: 250px; font-size: 46px;  width: 300px;
              height: 68px;">
		</div>	
	</div>
