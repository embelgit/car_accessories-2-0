...
<%@include file="y_commons/header1.jsp"%>
		...
		<!--  <script src="/SMT/staticContent/guru/js/supplier.js"></script> -->
...
<body class="master_form_img">
    ...
    <form action="supplier" name="supd1" method="post" class="form-horizontal" >
				...
				<div class="form-group" >
					...
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
								class="glyphicon glyphicon glyphicon-user"></i>
							</span> <input type="text" class="form-control" name="supplierName1"
								id="supplierName1" placeholder="Supplier Name" />
						</div>
					</div>
