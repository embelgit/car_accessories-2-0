...
<form action="salesmanPerformance" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-3"><strong>Salesman Name</strong></div>
			<div class="rTableHead col-md-2"><strong>Daily</strong></div>
			<div class="rTableHead col-md-2"><strong>Weekly</strong></div>
			<div class="rTableHead col-md-2"><strong>Monthly</strong></div>
			<div class="rTableHead col-md-2"><strong>Yearly</strong></div>
		</div>
