...
<body>	
   ...
   <% String type1= "";
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        	<marquee direction="right" onmouseover="this.stop();" onmouseout="this.start();" ><font color="crimson" style="font-size: 25px;"> Saubhadra Mahajan Shopping Mall </font> </marquee>
			<div class="wrapper">
            	<a href="http://localhost:8080/SMT/jsp/y_customer_feedback.jsp" class="btn btn-lg btn-md btn-success"> <span class="glyphicon glyphicon-home"></span> HOME </a>
            ...
            <div class="navbar-default sidebar container" role="navigation">
                <div class="sidebar-nav navbar-collapse">
					...
					<ul class="nav nav-pills nav-stacked">
						<li class="dropdown">
					    	<a class="dropdown-toggle" data-toggle="dropdown" href="#"> Sale Report <span class="caret"></span></a>
                ...
                %>	
								...
								<li><a href="sale_report_between_single_dates.jsp" ">Date Wise Sale Report</a></li>
								<li><a href="yearly_sale_report.jsp" ">Yearly Sale Report</a></li>
								<li><a href="date_wise_sale_report.jsp" ">Sale Report BetWeen Two Days </a></li>
								<li><a href="categorywise_sale_report.jsp" ">Category Wise Sale Report</a></li>
								<li><a href="subcategorywise_sale_report.jsp" ">Sub-Category Wise Sale Report</a></li>
								<li><a href="itemwise_sale_report.jsp" ">Item Wise Sale Report</a></li>
								<li><a href="supplierwise_sale_report.jsp" ">Supplier Wise Sale Report</a></li>
								<li><a href="sale_report.jsp" ">Sale Report</a></li>
								<li><a href="salereturndaywise.jsp" ">Sale Return Report Using Single Date</a></li>
							<%
				}
				%>		
							</ul>
					  	...
					  	<li class="dropdown">
					    	<a class="dropdown-toggle" data-toggle="dropdown" href="#"> Purchase Report <span class="caret"></span></a>
					    	<ul class="dropdown-menu">
					    	<%
                ...
                %>	
					       		<li><a href="purchase_report_between_two_dates.jsp" ">Purchase Report Between Two Days </a></li>
								<li><a href="purchase_report_by_shop.jsp" ">Purchase Report By Shop </a></li>
								<li><a href="purchase_report_yearly.jsp" ">Purchase Report Yearly </a></li>
								<li><a href="purchase_report_supplier_wise.jsp" ">Purchase Report Supplier Wise </a></li>
								<li><a href="itemwise_purchase_report.jsp" ">Item Wise Purchase Report</a></li>
								<li><a href="supplierwise_purchase_report.jsp" ">Supplier Wise Purchase Report</a></li>
								<li><a href="purchase_report.jsp" ">Purchase Report</a></li>
								<li><a href="categorywise_purchase_report.jsp" ">Category Wise Purchase Report</a></li>
								<li><a href="subcategorywise_purchase_report.jsp" ">Sub-Category Wise Purchase Report</a></li>
							<%
				}
				%>		
							</ul>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                %>	
                            <a href="http://http://localhost:8080/SMT/jsp/Birthday.jsp" class="btn list-group list-group-item list-group-item-success"> <h4> Birthday </h4></a>
                            <a href="http://http://localhost:8080/SMT/jsp/Anniversary.jsp" class="btn list-group list-group-item list-group-item-danger"> <h4> Anniversary </h4></a>
