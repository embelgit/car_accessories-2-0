...
<%@include file="y_commons/header1.jsp"%>
    ...
    <script src="/SMT/staticContent/y_css/style.css"></script>
    <link href="/SMT/jsp/subcategorywise_purchase_report.jsp" rel="stylesheet"/>
	...
	<div class="container-fluid">
			...
			<div align="center">
				<h2 class="form-name style_heading">Sub-Category Wise Purchase Report</h2>
			</div>
		</div>
		...
		<form action="subcategorywisePurchaseReport" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			<div class="rTableHead col-md-2"><strong>Order No</strong></div>
			<div class="rTableHead col-md-2"><strong>Supplier Name</strong></div>
			<div class="rTableHead col-md-2"><strong>Item Name</strong></div>
			<div class="rTableHead col-md-1"><strong>Category</strong></div>
			<div class="rTableHead col-md-1"><strong>SubCategory</strong></div>
			<div class="rTableHead col-md-1"><strong>Color</strong></div>
			<div class="rTableHead col-md-1"><strong>Size</strong></div>
			<div class="rTableHead col-md-1"><strong>Quantity</strong></div>
			<div class="rTableHead col-md-1"><strong>Total Amount</strong></div>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							</span> <input class="form-control" type="text" name="approvedBy" placeholder="Approved By" />
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
								class="glyphicon  glyphicon-hand-right"></i>
							</span> <input class="form-control" type="text" name="checkBy" placeholder="Check By" />
						</div>
					</div>
				</div>
            </div>
