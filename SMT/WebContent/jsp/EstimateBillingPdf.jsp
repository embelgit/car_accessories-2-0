...
<%
	...
	try {
	 ...
	 // step 3
		...
		ResultSet rs = stmt.executeQuery("select ItemName, CategoryName, Quantity, SalePrice,TotalAmount, Discount, GrossTotal ,Date ,totalperitem, TaxAmount,discountAmt,discountGrid,Gst,HsnSacNo,service_item,service_hsn,service_quantity,service_saleprice,service_disc_grid,service_discAmt,service_gst,service_igst,service_totalGrid,service_totalAmt from estimatequotationbill where BillNo =" + billno);
		...
		headerTable_cell = new PdfPCell(new Phrase("Bill No :"));
		...
		headerTable_cell = new PdfPCell(new Phrase("Date: "));
		headerTable_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		headerTable_cell.setColspan(2);
		headerTable_cell.setBorder(Rectangle.NO_BORDER | Rectangle.NO_BORDER);
		headertable.addCell(headerTable_cell);
		...
		InfoTable_cell = new PdfPCell(new Phrase("Car No: "));
		InfoTable_cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		InfoTable_cell.setBorder(Rectangle.NO_BORDER);
		infotable.addCell(InfoTable_cell);
		
		InfoTable_cell = new PdfPCell(new Phrase("Mob No: "));
		InfoTable_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		InfoTable_cell.setBorder(Rectangle.NO_BORDER);
		infotable.addCell(InfoTable_cell);
...
Long billno = (Long) session.getAttribute("carBillNO");
	...
	try {
	 ...
	 // step 3
		...
		ResultSet rs = stmt.executeQuery("select ItemName, CategoryName, Quantity, SalePrice,TotalAmount, Discount, GrossTotal ,Date ,totalperitem, TaxAmount,discountAmt,discountGrid,Gst,HsnSacNo,customerName,contactNo,description,Igst from estimatequotationbill where BillNo =" + billno);
...
//		document.add(headertable);
		...
		float[] infoColumnWidths = { 0.3f,0.3f };
		infotable.setWidths(infoColumnWidths);
