...
<form action="wholesaleCustomerList" method="post" class="form-horizontal">
	...
	<div class="col-lg-12">
		<div class="form-group-1">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 first">
				<input class="form-control" type="text" name="pCode" placeholder="Pin Code" />
			</div>
		</div>
	</div>		
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-2"><strong>City</strong></div>
