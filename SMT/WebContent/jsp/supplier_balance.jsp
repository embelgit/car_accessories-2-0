...
<form action="supplierBalance" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-3"><strong>Supplier Name</strong></div>
			<div class="rTableHead col-md-3"><strong>Address</strong></div>
			<div class="rTableHead col-md-3"><strong>Last Payment Date</strong></div>
			<div class="rTableHead col-md-2"><strong>Balance Amount</strong></div>
		</div>
