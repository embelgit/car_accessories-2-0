...
<script src="/SMT/staticContent/js/jquery-1.12.3.min.js"></script>
	...
	<div class="container">
		<h2 class="form-name-report">Day Wise Employee Commision</h2>
	</div>
	...
	<div class="col-lg-12">
		<div class="form-group-2">
			<div class="col-lg-12">
				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
					<input type="button" value="Search"  id="btn" onclick="  offer.getDayWiseSalesmanCommision(); " class="btn btn-lg btn-Success ">
				</div>
			</div>	
		</div>
	</div>			
