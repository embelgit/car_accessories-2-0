...
<script src="/SMT/staticContent/y_js/userlogin.js"></script>
    ...
    <!-- Custom Fonts -->
    <link href="/SMT/staticContent/y_css/font-awesome.min.css" rel="stylesheet" type="text/css">
                    ...
                    <div class="panel-body">
                        <form action="" method="post" name="createusr" name="createuser" >
                                ...
                                <div class="form-group-2">
                                    ...
                                    <input type="password" class="form-control" id="repassword" placeholder="Re-Password" autofocus="autofocus" onchange="check()" >
                                </div>
                              <div class="wrapper">
                                <input type="button" name="btn" value="Submit" class="btn btn-md btn-lg btn-success"  onclick=" userLogin()"/>
