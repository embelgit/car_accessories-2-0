...
<form action="purchaseReturnRegister" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			<div class="rTableHead col-md-1"><strong>Sr No</strong></div>
			<div class="rTableHead col-md-1"><strong>Purchase Date</strong></div>
			<div class="rTableHead col-md-1"><strong>Return Date</strong></div>
