...
<body class="master_form_img">
	...
	<div class="row header_margin_top">
			    <div align="center">
			  		<h2 class="form-name style_heading">Barcode Copy</h2>
			  	</div>
...
<form action="bsrcode" method="post" name="barcodeCopy" class="form-horizontal">  
	<div class="row">
				<div class="form-group">
					    <div class="col-sm-3 " align="right">
					    	  <label class="control-label">Enter Barcode No :<sup style="color: red">*</sup></label>
						</div>
						 <%
