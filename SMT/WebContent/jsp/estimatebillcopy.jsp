 ...
 <div class="container" style="float: "> 
 		...
 		<div class="row">
			<div align="center" style="margin-top: 75px">
				  <h2 class="form-name style_heading">Estimate Bill Copy</h2>
			</div>
		     ...
		     <div class="col-sm-offset-1 col-md-10">
 					...
 					<form action="" method="post" name="genIn">
 						<%
							...
							List list = fd.getBillNoAndNameses();
						%>
						<div class="row" style="margin-top: 25px;">
							<div class="col-md-offset-3" align="right">
								...
								<div class="col-md-4">
									<input list="seedBillNoe" id="BillNoe" class="form-control">
									<datalist id="seedBillNoe">
									<%
								...
								<div class="col-md-12 col-md-offset-" style="margin-top: 25px;" align="center">
									<button type="button" onclick="validateGenerateBillCOPYess()" name="btn" class="btn btn-success btn-lg btn-md button_hw button_margin_right" >Print </button>
								</div>
							</div>
