...
function grasstotalservice(){
	...
	var discount = document.getElementById("discountservice1").value;
	var gross = +total - +discount;
	
	document.getElementById("grossTotalservice").value = gross;
}
</script>
 <script type="text/javascript">
function calgrosstot(){
		...
		var spareGrossTotal = document.getElementById("grossTotalservice").value;
		...
		<%--   <h3 align="right" style="color: red; margin-right: 50px;">Bill No :: <%out.println(BillNo);   %></h3> --%>
		 ...
		 <div class="row">
		     <div class="col-sm-offset-1 col-md-10">
				...
				<!-- 			<label class="col-md-3 control-label" align="right">Barcode no:</label> -->
                 ...
                 <div class="col-md-2" align="right">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" id=""  placeholder="Contact Number" autofocus  />
							</div>
		   </div>	
				...
				<div class="row" style="margin-top: 10px; margin-left:3%; ">
					<div class="col-md-12">
						...
						<div class="row form-group" >
							...
							<div class="col-md-3" style="margin-top:10px;">
								<input type="text" class="form-control" id="discount"  placeholder="Discount In Rs" autofocus onkeyup="grasstotal();calgrosstot(); return false;" />
							</div> 
						</div>
					...
					<div class="col-md-8">
						<!-- <div class="row" style="margin-top: 15px;"> -->
						  ...
						  <div class="col-md-2" align="right">
							...
							<div class="col-md-2">
							 <div class="input-group">
							   <!-- <span class="input-group-addon">
								...
								<input type="text" class="form-control" id="discountservice1"  placeholder="Discount In Rs" autofocus onkeyup="grasstotalservice();calgrosstot(); return false;" />
							 </div> 
							</div> 
							...
							<div class="col-md-2">
							<input type="text" class="form-control" id="grossTotalservice" placeholder="Gross Total"  readonly="readonly"/>
							</div> 
						</div>
			...
			<div class="row form-group">
				...
				<div class="row" style="margin-top:20px;">
					<div align="center" class="margin-top-50">
						<button type='button' class="btn btn-success btn-lg bottomButtons btn-md button_hw button_margin_right"  id="btnSubmit" onclick="regcreditcustomerbill();" >Save</button>
						<button type='button' class="btn btn-danger btn-lg bottomButtons btn-md button_hw button_margin_right">Cancel</button>
					</div>
					<!-- resBillService();resotherbill(); -->
				</div> 
		</div>
