...
<form action="stockInwardRegister" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-1"><strong>Date Of Receipt</strong></div>
			<div class="rTableHead col-md-1"><strong>Inward From(Location)</strong></div>
			<div class="rTableHead col-md-1"><strong>Voucher No./LR No.</strong></div>
			<div class="rTableHead col-md-1"><strong>Goods Description</strong></div>
			<div class="rTableHead col-md-2"><strong>Voucher Quantity(No.pcs)</strong></div>
			<div class="rTableHead col-md-2"><strong>Quantity Received(No.pcs)</strong></div>
			<div class="rTableHead col-md-1"><strong>Delivery Person(Name)</strong></div>
			<div class="rTableHead col-md-1"><strong>Received by(Name)</strong></div>
			<div class="rTableHead col-md-1"><strong>Remarks</strong></div>
		</div>
