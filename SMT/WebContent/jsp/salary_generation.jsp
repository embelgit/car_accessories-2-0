...
<form action="salaryGeneration" method="post" class="form-horizontal">
	...
	<div class="col-lg-12 form-group-1">
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6" style="margin-right: -80px;">
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-1"><strong>Basic Salary</strong></div>
			<div class="rTableHead col-md-1"><strong>Attended Days</strong></div>
			<div class="rTableHead col-md-1"><strong>Incentives</strong></div>
			<div class="rTableHead col-md-2"><strong>Non-Working Days</strong></div>
			<div class="rTableHead col-md-1"><strong>Tax</strong></div>
			<div class="rTableHead col-md-1"><strong>PF</strong></div>
			<div class="rTableHead col-md-1"><strong>Deduction</strong></div>
			<div class="rTableHead col-md-1"><strong>Net Salary</strong></div>
		</div>
