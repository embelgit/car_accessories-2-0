...
<form action="yearlySalePurchaseReport" method="post" class="form-horizontal">
	<div class="rTable">
		<div class="rTableRow">
			<div class="rTableHead col-md-2"><strong>Year</strong></div>
			<div class="rTableHead col-md-2"><strong>Purchase Cost</strong></div>
			<div class="rTableHead col-md-2"><strong>Sales Amount</strong></div>
		</div>
