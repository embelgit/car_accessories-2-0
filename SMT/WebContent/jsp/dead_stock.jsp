...
<form action="deadStock" method="post" class="form-horizontal">
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-1"><strong>Barcode</strong></div>
			<div class="rTableHead col-md-2"><strong>Item Name</strong></div>
			<div class="rTableHead col-md-2"><strong>Supplier Name</strong></div>
			<div class="rTableHead col-md-1"><strong>Dead Quantity</strong></div>
			<div class="rTableHead col-md-1"><strong>Sold</strong></div>
			<div class="rTableHead col-md-1"><strong>Remaining</strong></div>
