						...
						<div class="col-sm-2">
							<div class="input-group">
									<span class="input-group-addon">
										...
										<input type="text" id="pin" name="pin" class="form-control" placeholder="Pin Code" />
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						 			<div class="input-group">
										...
										<input type="text" id="tinNo" name="tinNo" class="form-control" placeholder="TIN No" />
							  		</div>
						</div>
						...
						<div class="col-sm-2">
							<div class="input-group">
									...
									<input type="text" id="cstNo" name="cstNo" class="form-control" placeholder="CST No" />
							</div>
						</div>
						...
						<div class="col-sm-2">
							<div class="input-group">
									...
									<input type="text" id="creditLimit" name="creditLimit" class="form-control" placeholder="Credit Limit" />
							</div>
						</div>
    ...
    <div class="row">
	        <div class="col-sm-offset-1 col-md-10">
			    <div align="left" style="color:#72459a;">
			  		<h3 class="form-name"><u>Bank Details</u></h3>
			  	</div>
			 </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
						 			<div class="input-group">
									   ...
									   <input type="text" id="ifscCode" name="ifscCode" class="form-control" placeholder="IFSC" />
							  		</div>
						</div>
		...
		<div class="row buttons_margin_top">
			<div align="center">
    			<input type="button" value="save"  id="btn" onclick="supplierDetails()" class="btn btn-lg btn-success btn-md button_hw button_margin_right"/> 
				<input type="reset" value="Cancel" class="btn btn-lg btn-danger btn-md button_hw button_margin_right"/>
				<input type="button" value="Edit Supplier Bill " onclick="window.location.href='http://localhost:8080/SMT/jsp/y_SupplierEdit.jsp'" class="btn btn-lg btn-primary btn-md button_hw button_margin_right" /> 
			</div>
		</div>	
