...
<%@include file="commons/header.jsp"%>
    ...
    <link href="/SMT/jsp/monthly_purchase_and_sale_report.jsp" rel="stylesheet"/>
...
<form action="monthlyPurchase&SaleReport" method="post" class="form-horizontal">
	...
	<div class="rTable">
		<div class="rTableRow">
			...
			<div class="rTableHead col-md-1"><strong>Mfg.company</strong></div>
			<div class="rTableHead col-md-1"><strong>Op.Stock</strong></div>
			<div class="rTableHead col-md-1"><strong>Purchase Quantity</strong></div>
			<div class="rTableHead col-md-2"><strong>Party Name</strong></div>
			<div class="rTableHead col-md-1"><strong>Batch No</strong></div>
			<div class="rTableHead col-md-1"><strong>Expiry Date</strong></div>
			<div class="rTableHead col-md-1"><strong>Total Stock</strong></div>
			<div class="rTableHead col-md-1"><strong>Sold Quantity</strong></div>
			<div class="rTableHead col-md-1"><strong>Close Stock</strong></div>
		</div>
