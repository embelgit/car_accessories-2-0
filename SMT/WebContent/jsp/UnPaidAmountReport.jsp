...
<%@include file="y_commons/header1.jsp"%>
	   ...
	   <div class="container-fluid">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading">UnPaid TotalAmount Of Supplier</h2>
			</div>
		</div>
...
<div class="row" align="center">
 <div class="table-responsive" style="width: 500">
	<table class= "table table-bordered table-striped table-condensed cf" id="unPaidAmt" class="display" style=" border: 2px solid black; border-collapse: collapse;">
		<thead>
			<tr>
